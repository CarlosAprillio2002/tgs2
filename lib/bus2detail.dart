          ...
          children: <Widget>[
           ...
           Container(
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text('Bus Kangaroo Vacation adalah Bus yang memiliki kapasitas penumpang sebanyak 32 orang ini dibekali dengan peralatan makan, berbagai makanan berat serta ringan, dan juga dilengkapi kamar kecil dan wifi.' , style: TextStyle(fontSize: 20, color: Colors.white),),
                       
                    ],
                  ),
            Text(
              "HARGA SEWA: Rp.200.000,00 per orang",
