          ...
          children: <Widget>[
           ...
           Container(
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text('Bus Lintas Pontianak adalah Bus yang memiliki kapasitas penumpang sebanyak 26 orang ini dibekali dengan peralatan makan, berbagai makanan berat serta ringan, dan juga dilengkapi kamar kecil dan wifi.' , style: TextStyle(fontSize: 20, color: Colors.white),),
                       
                    ],
                  ),
            Text(
              "HARGA SEWA: Rp.150.000,00 per orang",
