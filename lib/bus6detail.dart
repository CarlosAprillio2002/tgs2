          ...
          children: <Widget>[
           ...
           Container(
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text('Bus Japanese Tour adalah Bus yang memiliki kapasitas penumpang sebanyak 36 orang ini dibekali dengan peralatan makan, berbagai makanan berat serta ringan, dan juga dilengkapi kamar kecil dan wifi.' , style: TextStyle(fontSize: 20, color: Colors.white),),
