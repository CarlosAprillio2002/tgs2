...
class Bus4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("BLUE BIRD"),
          ...
          children: <Widget>[
           ...
           Container(
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text('Bus Blue Bird adalah Bus yang memiliki kapasitas penumpang sebanyak 34 orang ini dibekali dengan peralatan makan, berbagai makanan berat serta ringan, dan juga dilengkapi kamar kecil dan wifi.' , style: TextStyle(fontSize: 20, color: Colors.white),),
                       
                    ],
                  ),
            Text(
              "HARGA SEWA: Rp.280.000,00 per orang",
